...
import { DigitRecognitionService } from './digit-recognition.service';
...
@Component({
  ...
  styleUrls: ['./digit-recognition.component.scss']
})
export class DigitRecognitionComponent implements OnInit {

  constructor(private drService: DigitRecognitionService) { }
